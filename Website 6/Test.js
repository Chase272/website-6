...
resultDiv.className = "result-div"
  ...
  if (counter == 1 && score < 7) {
    ...
    totalscore.innerHTML = "YOUR SCORE IS:"+score + "/50";
    resultDiv.appendChild(totalscore);
    resultPara.innerHTML = "It seems like you are safe from this Threat, as your score lies below 7. this score is calculated on the basis of your responses and the results may vary.Your score is based on the following table:"+"<table class = result-tab>"+
"<tr>"
    +"<th>No.</th>"
  +"  <th>Score</th>"
   +" <th>Result</th>"
 +" </tr>"
  ...
  +"<tr>"
   + "<td> 2 </td>"
    +"<td>" +"Score between 7 to 20" +"</td>"
    +"<td>Low Risk</td>"
  +"</tr>"
  +"<tr>"
   + "<td> 3 </td>"
    +"<td>" +"Score above 20" +"</td>"
    +"<td>High Risk</td>"
  +"</tr><table>"
  ...
  if (counter == 2 && score < 20) {
    ...
    totalscore.innerHTML = "YOUR SCORE IS:"+score + "/50";
    resultDiv.appendChild(totalscore);
    resultPara.innerHTML = "It looks like you are at a low risk zone but vulnerable to Catching sympotoms , as your score lies between 7 and 20. This Score is calculated on the basis of your responses and the results may vary.Your score is based on the following table:"+"<table class = result-tab>"+
    "<tr>"
        +"<th>No.</th>"
      +"  <th>Score</th>"
       +" <th>Result</th>"
  ...
  totalscore.innerHTML = "YOUR SCORE IS:"+score + "/50";
    resultDiv.appendChild(totalscore);
    resultPara.innerHTML = "It looks like you are at High Risk zone and are highly Vulnerable to Black Fungus, Chances are, you probably have Black Fungus And Should Strike With your Medical Advisor. Your score is based on the following table:"+"<table class = result-tab>"+
    "<tr>"
        +"<th>No.</th>"
      +"  <th>Score</th>"
       +" <th>Result</th>"
