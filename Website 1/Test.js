...
resultDiv.className = "result-div"
  ...
  if (counter == 1 && score < 7) {
    ...
    resultPara.innerHTML = "It seems like you are safe from this Threat, as your score lies below 7. this score is calculated on the basis of your responses and the results may vary.";
  ...
  if (counter == 2 && score < 20) {
    ...
    totalscore.innerHTML = score + "/50";
    resultDiv.appendChild(totalscore);
    resultPara.innerHTML = "It looks like you are at a low risk zone but vulnerable to Catching sympotoms , as your score lies between 7 and 20. This Score is calculated on the basis of your responses and the results may vary.";
    resultDiv.appendChild(resultPara);
    submitbutton.style.display = "none";
  }
else if (counter==3){
  var totalscore = document.createElement("h3");
    totalscore.innerHTML = score + "/50";
    resultDiv.appendChild(totalscore);
    resultPara.innerHTML = "It looks like you are at High Risk zone and are highly Vulnerable to Black Fungus, Chances are, you probably have Black Fungus And Should Strike With your Medical Advisor. ";
    resultDiv.appendChild(resultPara);
    submitbutton.style.display = "none";
}
